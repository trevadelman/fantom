...
//////////////////////////////////////////////////////////////////////////
  ...
  private Void header(TypeDef t)
  {
    ...
    w("#").nl
    // Sentinel for distinguishing "no argument" from "argument is None"
    // Fixes nullable field bug: field(None) must set to null, not read
    w("_UNSET = object()").nl
    nl
  }
...
//////////////////////////////////////////////////////////////////////////
  ...
  **
  ...
  private Void fieldAccessors(FieldDef f)
  {
    ...
    // Return type is always Optional because setter path returns None
    retHint := pyTypeHint(f.type.toNullable)

    // Generate combined getter/setter: def fieldName(self, _val_=_UNSET) -> Optional[T]:
...
//////////////////////////////////////////////////////////////////////////
  ...
  ** In Python, we combine them into one method with optional parameter
  private Void combinedFieldAccessor(FieldDef f)
  {
    ...
    // Generate: def fieldName(self, _val_=_UNSET) -> Optional[T]:
    //   if _val_ is _UNSET:
    //     # getter body
    //   else:
    //     # setter body
